<div class="navbar"><a href="{U_INDEX}">{L_INDEX}</a>&gt;<a href="{U_ALBUM}">{L_ALBUM}</a>&gt;<a href="{U_VIEW_CAT}">{CAT_TITLE}</a>&gt;上传图片</div>
<form name="upload" action="{S_ALBUM_ACTION}" method="post" enctype="multipart/form-data">
<div class="catSides">{L_UPLOAD_PIC}</div>
