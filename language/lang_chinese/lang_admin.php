...
$lang['Shop_pay'] = '支付管理';
// 需要该功能自己汉化
$lang['Shop_Open_Pay_money'] = '是否开启支付系统';//'Включить систему выплат за сообщения';
$lang['Shop_Kurs_Payment'] = '人民币比论坛币汇率';//'Курс обмена монет на рубли (сколько выдавать рублей за одну монету)';
