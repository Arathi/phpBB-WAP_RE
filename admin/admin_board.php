...
else
{
	...
	if( isset($HTTP_POST_VARS['submit']) )
	{
		$message = $lang['Config_updated'] . "<br /><br />" . sprintf($lang['Click_return_config'], "<a href=\"" . append_sid("admin_board.$phpEx") . "\">", "</a>") . "<br /><br />" . sprintf($lang['Click_return_admin_index'], "<a href=\"" . append_sid("index.$phpEx?pane=left") . "\">", "</a>");
...
$style_select 		= style_select($new['default_style'], 'default_style');
...
$icq_yes 			= ($new['send_user_icq']) ? 'checked="checked"' : '';
$icq_no 			= (!$new['send_user_icq']) ? 'checked="checked"' : '';
...
$template->assign_vars(array(
	...
	"L_CAPTCHA_IN_TOPIC" 		=> $lang['Captcha_in_topic'],
	...
	"L_MAX_USER_TOPICS_PER_PAGE" 	=> $lang['Max_Topics_per_page'],
	"L_MAX_USER_POSTS_PER_PAGE" 	=> $lang['Max_Posts_per_page'],
	...
	'L_MIN_LOGIN_REGDATE' 			=> $lang['Min_login_regdate'], 
	'L_MIN_LOGIN_REGDATE_EXPLAIN' 	=> $lang['Min_login_regdate_explain'], 
	...
	"L_INDEX_ANNOUNCEMENT" 			=> $lang['Index_announcement'],
	"L_SPISOK" 						=> $lang['Index_spisok'],
	"L_ICQ_SEND" 					=> $lang['Icq_send'],
	"L_ICQ_SEND_EXPLAIN" 			=> $lang['Icq_send_explain'],
	"L_DEFAULT_ICQ" 				=> $lang['Default_icq'],
	"L_DEFAULT_ICQ_EXPLAIN" 		=> $lang['Default_icq_explain'],
	"L_DEFAULT_ICQ_PASS" 			=> $lang['Default_icq_pass'],
	"L_FLOOD_ICQ_INTERVAL" 			=> $lang['Flood_icq_interval'],
	"L_FLOOD_ICQ_INTERVAL_EXPLAIN" 	=> $lang['Flood_icq_interval_explain'],
	"L_MESSAGE_QUOTE" 				=> $lang['Message_quote'],
	"L_POSLEDNEE_REDAKTIROVANIE" 	=> $lang['Poslednee_redaktirovanie'],
	"L_POSLEDNEE_REDAKTIROVANIE_EXPLAIN" 	=> $lang['Poslednee_redaktirovanie_explain'],
	"L_INDEX_ANNOUNCEMENT_EXPLAIN" 	=> $lang['Index_announcement_explain'], 
	...
	"DEFAULT_ICQ" 					=> $new['default_icq'], 
	"DEFAULT_ICQ_PASS" 				=> $new['default_icq_pass'], 
	"FLOOD_ICQ_INTERVAL" 			=> $new['flood_icq_interval'], 
