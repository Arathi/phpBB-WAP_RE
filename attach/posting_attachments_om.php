...
if ($importurl<>NULL)
{
	...
	$tmp_name_file = $importurl;
} else {
	// File Attachment for Opera Mini by чел
...
class attach_parent
{
	...
	{
		global $HTTP_POST_VARS, $HTTP_POST_FILES, $tmp_name;
	...
	function display_attachment_bodies()
	{
		...
		{
			init_display_template('attachbody', '{ADD_ATTACHMENT_BODY}', 'add_attachment_body_om.tpl');
	...
	{
		global $HTTP_POST_FILES, $db, $HTTP_POST_VARS, $error, $error_msg, $lang, $attach_config, $userdata, $upload_dir, $forum_id, $opera_mini, $tmp_name, $importurl, $tmp_name_file, $importfsz;
