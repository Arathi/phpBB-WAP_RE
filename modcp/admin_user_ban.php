...
if ( !empty($setmodules) )
{
	...
	$modcp_module['Users']['Ban_Management'] = $filename;
	return;
}
...
else
{
	...
	$select_userlist = '';
	$select_userlist .= '<option value="-1" checked="checked">不进行操作</option>';
	for($i = 0; $i < count($user_list); $i++)
	{
	...
	$select_userlist = '<select name="unban_user[]">' . $select_userlist . '</select>';
	...
	$select_iplist = '';
	$select_iplist .= '<option value="-1" checked="checked">不进行操作</option>';
	
	$select_emaillist = '';
	$select_emaillist .= '<option value="-1" checked="checked">不进行操作</option>';
	...
	$select_iplist = '<select name="unban_ip[]">' . $select_iplist . '</select>';
	$select_emaillist = '<select name="unban_email[]">' . $select_emaillist . '</select>';
